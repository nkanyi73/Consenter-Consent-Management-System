    ...
    <v-sheet id="sheet">
        <validation-observer ref="observer" v-slot="{ invalid }">
            <form @submit.prevent="submit">
                ...
                <validation-provider v-slot="{ errors }" name="mailing" rules="required">
                    <v-text-field v-model="mailing" :error-messages="errors" label="Mailing Address" required></v-text-field>
                </validation-provider>
                ...
                <validation-provider v-slot="{ errors }" name="country" rules="required">
                    <v-text-field v-model="country" :error-messages="errors" label="Country" required></v-text-field>
                </validation-provider>
            ...
            //retrieve user's contract address
                ...
                window.ethereum.request({
                    ...
                    window.ethereum.request({
                        ...
                        const decoded = web3.eth.abi.decodeParameters(['bytes32', 'bytes32', 'bytes32', 'bytes32'], res);
